(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e={name:`Antonio Vivas`,hole:`Full Stack Developer`,description:`Desenvolvedor Full Stack com sólida trajetória no desenvolvimento de aplicações web, atuando desde 2019 em projetos acadêmicos, freelances e, desde 2022, no desenvolvimento profissional de sistemas empresariais de grande porte. Possuo experiência na criação e evolução de plataformas de gestão e e-commerce utilizando Laravel, Vue.js, Livewire e Alpine.js, desenvolvendo soluções completas que abrangem modelagem de dados, APIs REST, integrações com gateways de pagamento e transportadoras, além da construção de interfaces modernas e responsivas.`,info:{phone:{icon:`fa-solid fa-phone`,value:`+55 (71) 98550-00085`,link:`tel:+5571985500085`},email:{icon:`fa-regular fa-envelope`,value:`antoniovivascavalcante@gmail.com`,link:`mailto:antoniovivascavalcante@gmail.com`},address:{icon:`fa-solid fa-location-dot`,value:`Lauro de freitas/`,link:`https://www.google.com/maps/place/Lauro+de+Freitas,+BA`},linkedin:{icon:`fa-brands fa-linkedin`,value:`https://www.linkedin.com/in/antonio-vivas-41795720a/`,link:`https://www.linkedin.com/in/antonio-vivas-41795720a/`},github:{icon:`fa-brands fa-github`,value:`https://github.com/antoniovivasbc`,link:`https://github.com/antoniovivasbc`}}},t=({name:e,hole:t,description:n,info:r})=>`
